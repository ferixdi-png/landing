...
(function () {
  ...
  var actions = [
    function (c) { return 'Криейтер из ' + c + ' <strong>забрал систему</strong> и запускает своих AI-актёров'; },
    function (c) { return 'Участник из ' + c + ' <strong>опубликовал первый Reels</strong> — AI уже работает на него'; },
    function (c) { return '<strong>Новый участник</strong> из ' + c + ' подключился. Пока ты читаешь — другие уже действуют'; },
    function (c) { return 'Криейтер из ' + c + ' <strong>перешёл на AI-контент</strong> — харизма актёров вместо камеры'; },
    function (c) { return '<strong>+1 участник</strong> из ' + c + '. AI ломает рынок — кто раньше, тот забирает'; }
  ];
